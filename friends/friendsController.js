        ...
        friend
            ...
            .catch(err => {
                ...
                if (err.name === "ValidationError") {
                    ...
                    firstName =
                        "firstName" in err.errors ? firstName.message : "";
    ...
    .get((req, res) => {
        Friend.findById(req.params.id)
            ...
            .catch(err => {
                ...
                res.status(500).json({
                    errorMessage:
                        "The friend information could not be retrieved.",
                });
            });
    })
    .delete((req, res) => {
            ...
            .then(response => {
                if (response === null) {
                    res
                        .status(404)
                        .json(
                            `Cannot delete friend with the specified ID: ${
                                req.params.id
                            }.`,
                        );
                } else {
        ...
        Friend.findByIdAndUpdate(req.params.id, req.body)
            ...
            .catch(err => {
                if (err.name === "CastError") {
                    ...
                    res
                        .status(500)
                        .json({ errorMessage: "friend couldnot be updated" });
                }
            });
    });
